...
import SupplierMegaMenuMobile from "./SupplierMegaMenuMobile";

class SupplierNavMobile extends Component {
  constructor() {
    super();
    this.state = {
...
export default SupplierNavMobile;
