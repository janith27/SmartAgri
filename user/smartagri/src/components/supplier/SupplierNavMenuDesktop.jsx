                ...
                <Container fluid={"true"} className="fixed-top shadow-sm p-2 mb-0 bg-white">
                    <Row>
                        <div class="d-flex justify-content-between">
                            ...
                            <h1>{name}</h1>
                            <div>
                                <Link to="/" className="h4 btn"><Button variant="outline-success">Dashboard</Button></Link>
                                <Link to="/" className="h4 btn"><Button variant="outline-success">Chat</Button></Link>
                                <Link to="/" className="h4 btn"><Button variant="outline-success">Notifiction</Button></Link>
