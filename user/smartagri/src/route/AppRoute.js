      ...
      <Fragment>
        <Routes>
          ...
          <Route
            ...
            element={
              <FarmerHomePage user={this.state.user} setUser={this.setUser} />
            }
          />
          <Route
            exact
            path="/instructordashboard"
            element={<InnstructorHomePage />}
          />
          <Route
            exact
          ...
          <Route
            ...
            element={<FarmerNotificationPage />}
          />
          <Route
            exact
            path="/productdetails"
          ...
          <Route
            exact
            path="/farmerappointmentcreate"
            element={
              <FarmerAppointmentPage
          ...
          <Route
            exact
            path="/appointmentform/:keyemail"
            element={<AppointmentFormPage user={this.state.user.email} />}
          />
        </Routes>
      </Fragment>
    );
